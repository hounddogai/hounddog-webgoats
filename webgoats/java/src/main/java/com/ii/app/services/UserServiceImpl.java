...
public class UserServiceImpl implements UserService {
    ...
    public UserOut create(UserIn userIn) {
        ...
        logger.info("Created user : " + save);
        String surname = mapped.getUsername();
        String address = mapped.getAddress().getStreet();
		logger.info(surname);
        logger.error("Example exception for User " + save, new Throwable());
        writer.appendUser(save);
		logger.error(address +  " is logged");
        return userMapper.userToUserOut(save);
    }
    ...
    @Override
    public UserOut findCurrentUserOrNull() {
    ...
    public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
        Optional<User> byIdentifier = userRepository.findByIdentifier(s);
        if(!byIdentifier.isPresent()){
            byIdentifier=userRepository.findByEmail(s);
        }
        return byIdentifier
